...
export const metadata = generateMetadata(
  "Classements des artistes",
  "Explorez les classements des artistes dans tous les genres musicaux : Rap FR, Pop, Jazz, Rap US, R&B, Musiques Latines, Rock, Electro, K-pop et Afrobeats. Votez et découvrez les tendances !",
  [
    "classement artistes",
    "top artistes",
    "meilleurs artistes",

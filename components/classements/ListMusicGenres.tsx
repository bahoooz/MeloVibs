            ...
            <div className="flex gap-5 xl:gap-6">
              ...
              >
                ...
                <Image
                  ...
                  width={1170}
                  height={1755}
                  className="h-full object-cover rounded-2xl brightness-50 [object-position:40%_50%] xl:[object-position:55%_55%]"
                />
              </Link>
              <Link
                href={"/classements/r&b"}
